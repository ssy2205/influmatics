...
- [x] Create a GitHub-friendly package skeleton.
...
- [ ] Integrate ONT consensus pipeline reports.
- [ ] Replace online BLAST prototype with local BLAST screening.
- [ ] Unify legacy R tree scripts into one parameterized visualizer.
- [ ] Add HyPhy FEL/MEME wrappers.
- [ ] Add metadata phylogeography summaries and optional Treetime workflow.
